#Second revision of the walking game
...
#Rooms can be added and removed without changing the overall code, and parts of the code do not have to be repeated over and over.
